...
data_dir = './dataset_original/TMIdata_subject_JPG'
...
dest_folder_train = './TMIdata_split_by_person/train'
dest_folder_val = './TMIdata_split_by_person/val'
dest_folder_test = './TMIdata_split_by_person/test'
